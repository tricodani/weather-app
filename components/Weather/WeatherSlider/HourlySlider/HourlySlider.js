            ...
            <>
                ...
                <div className="row">
                  <div className="col-6 col-xs-6 col-sm-6 col-md-3">
                    <div className={styles["modal__item"]}>
                      ...
                      <h4 className={styles["modal__item__title"]}>Humidità</h4>
                  ...
                  <div className="col-6 col-xs-6 col-sm-6 col-md-3">
                    <div className={styles["modal__item"]}>
                      ...
                      <h4 className={styles["modal__item__title"]}>Precipitazioni</h4>
                  ...
                  <div className="col-6 col-xs-6 col-sm-6 col-md-3">
                    <div className={styles["modal__item"]}>
                      ...
                      <h4 className={styles["modal__item__title"]}>Velocità vento</h4>
                  ...
                  <div className="col-6 col-xs-6 col-sm-6 col-md-3">
                    <div className={styles["modal__item"]}>
                      ...
                      <h4 className={styles["modal__item__title"]}>UV</h4>
                      {item.uvIndex}
                    </div>
                  </div>
                </div>
              ...
              <div className={styles["modal-body"]}>
                ...
                <ul>
                  ...
                  <li>
                    <strong>Raffiche vento</strong> <span>{Math.round(item.windGust)} mph</span>
                  </li>
                  {item.precipAccumulation && (
                    <li>
                      <strong>Neve</strong> <span>{item.precipAccumulation}"</span>
                    </li>
                  )}
                  <li>
                    <strong>Nuvolosità</strong> <span>{formatAsPercentage(item.cloudCover)}</span>
                  </li>
                  <li>
                    <strong>Pressione atmosferica</strong> <span>{calculatePressure(item.pressure)} in</span>
                  </li>
                  <li>
